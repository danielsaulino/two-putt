...
/* package two-putt-0.1.0.0 */
#ifndef VERSION_two_putt
#define VERSION_two_putt "0.1.0.0"
#endif /* VERSION_two_putt */
#ifndef MIN_VERSION_two_putt
#define MIN_VERSION_two_putt(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_two_putt */
...
#define CURRENT_PACKAGE_KEY "two-putt-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "two-putt-0.1.0.0-inplace"
